...
export default {
  data() {
    return {
      ...
      contacts: [
        {
          name: "Alessandro",
          linkedin:
            "https://www.linkedin.com/in/jordi-alessandro-masci-94083029b/",
        },
        {
          name: "Laura",
          linkedin: "https://www.linkedin.com/in/laura-demeglio93/",
        },
        {
          name: "Luigi",
          linkedin: "https://www.linkedin.com/in/luigi-tarallo-a459baa3/",
        },
        {
          name: "Miruna",
          linkedin: "https://www.linkedin.com/in/miruna-buruiana-0a3aaa269/",
        },
        {
          name: "Gabriele",
          linkedin: "https://www.linkedin.com/in/gabriele-di-emmanuele/",
        },
      ],
      NoteLegali: [
      ...
      Aiuto: ["Contatti", "FAQ", "Tipi di cucina"],
    };
  },
};
</script>
  ...
  <div class="footer-container p-3">
    <div class="row justify-content-center">
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 my-2">
        <div class="link-col">
          <h4>Note Illegali</h4>
          <a href="#" v-for="link in NoteLegali">{{ link }}</a>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 my-2">
        <div class="link-col">
